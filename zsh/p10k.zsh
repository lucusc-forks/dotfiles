# Generated by Powerlevel10k configuration wizard on 2023-06-19 at 21:29 MDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 3275.
# Wizard options: powerline, unicode, lean, 12h time, 2 lines, disconnected, left frame,
